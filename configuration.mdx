...
| `WHATSAPP_AUTH_DIR` | `../.wwebjs_auth` (relative to project root) | Directory where the WhatsApp Web Linked Devices session (Chromium profile) is persisted. |
...
- **Default location** (relative to project root): `.wwebjs_auth/session-default`
