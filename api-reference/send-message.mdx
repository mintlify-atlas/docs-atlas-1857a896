---
title: "POST /api/send — Send a WhatsApp Text Message to a Contact"
sidebarTitle: "Send Message"
description: "POST /api/send delivers a text message to any WhatsApp number via the authenticated Linked Devices session and returns the message ID and send timestamp."
---
