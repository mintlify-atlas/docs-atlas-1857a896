---
title: "GET /api/messages — Read Messages from a WhatsApp Chat"
sidebarTitle: "Read Messages"
description: "GET /api/messages and POST /api/messages both fetch the most recent messages from a WhatsApp chat by phone number, with optional limit control."
---
