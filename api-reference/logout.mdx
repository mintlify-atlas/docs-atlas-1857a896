---
title: "POST /api/logout — End WhatsApp Session"
sidebarTitle: "POST /api/logout"
description: "POST /api/logout gracefully ends the WhatsApp Web session, destroys the Chrome client, and resets the server state to stopped."
---
