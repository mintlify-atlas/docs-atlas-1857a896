---
title: "GET /api/status — WhatsApp Web Client State & Info"
sidebarTitle: "Status"
description: "GET /api/status returns the WhatsApp Web client state — lifecycle, QR availability, Chrome settings, and account details for the authenticated session."
---
