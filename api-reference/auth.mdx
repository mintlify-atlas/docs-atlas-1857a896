...
sidebarTitle: "POST /api/auth/start"
description: "POST /api/auth/start launches the WhatsApp Web client and Chrome, initiating the authentication flow before pairing."
---
