---
title: "WhatsApp MCP API REST Endpoints Reference"
sidebarTitle: "Overview"
description: "Complete reference for all WhatsApp MCP API REST endpoints — status, auth, send message, list chats, read messages, logout, and QR page."
---
...
All REST endpoints return `application/json` with pretty-printed output (2-space indentation), except `GET /qr` which returns an HTML page. A successful response always contains an `ok: true` field at the top level (where applicable). Example:
