---
title: "WhatsApp MCP API Quickstart: Install, Pair, and Send"
sidebarTitle: "Quickstart"
description: "Install WhatsApp MCP API, pair your phone using a pairing code, and send your first message through the REST API in five guided steps."
---
