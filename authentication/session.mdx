---
title: "Managing Persistent WhatsApp Sessions"
...
The cleanest way to end a session is through the logout endpoint. This instructs WhatsApp Web to revoke the linked device credential, then destroys the local client:
