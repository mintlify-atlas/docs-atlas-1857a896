---
title: "Pair WhatsApp Using a Phone-Number Code"
sidebarTitle: "Pairing Code"
description: "Request a numeric WhatsApp Linked Devices pairing code via POST /api/pairing-code and link your phone without scanning a QR code."
---
...
<Tip>
  Pairing codes expire after a short window. If you don't enter the code in time or WhatsApp rejects it, simply call `POST /api/pairing-code` again with the same phone number to receive a fresh code.
</Tip>
