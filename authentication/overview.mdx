---
title: "WhatsApp Authentication: Linked Devices Explained"
...
4. **Session saved locally** — After a successful pair, whatsapp-web.js persists the full Chrome user profile — including WhatsApp Web's IndexedDB encryption keys — inside `.wwebjs_auth/session-default`. The client state then moves to `ready`.
...
| State | Meaning |
|---|---|
| `stopped` | Server has not been started or the client has not been initialized. |
